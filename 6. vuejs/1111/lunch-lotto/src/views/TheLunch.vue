<template>
  <div>
    <h2>점심메뉴 추천</h2>  
    <button @click="pickOneInLunchMenu">점심 뭐먹지...?</button>
    <h2>오늘의 점심 메뉴는: {{ selectedLunchMenu }}</h2>
    <hr>
    <h3>로또 숫자 갯수 입력</h3>
    <input v-model="lottoNum" placeholder="추천 받고 싶은 로또 숫자 갯수 입력" type="text">
    <br><br>
    <button @click="gotoLotto">로또 하러 가즈아~</button>
  </div>
</template>
